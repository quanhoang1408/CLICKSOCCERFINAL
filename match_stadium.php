<?php
    ...
    include './php/creatematch.php';
    include './get_match_stadium.php';
...
<html lang="en">
  ...
  <h2 class="textprimary" style="color:royalblue; font-size:30px; padding:10px; text-align:center"><?php echo $_SESSION['findname']?></h2>
  <?php
            $result = getmatchesstadium($_SESSION['findname']);
            while($row = mysqli_fetch_assoc($result)){
                creatematch($row['namematch'],$row['match_day'],$row['id']);
            }
          ?>
  </div>
</div>
