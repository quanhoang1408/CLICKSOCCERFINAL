...
<body class="bodybackground">
    ...
    <p class="hello">Hello, <?php echo $_SESSION['user_name']?></p>
    <div style="background:#A0E7E5; width:1000px; margin:auto; border: 2px solid black" >
        <h2 class="textprimary" style="color:royalblue; font-size:30px; padding:10px; text-align:center">Most Popular Match Right Now</h2>
          <?php
            $result = getmatches();
