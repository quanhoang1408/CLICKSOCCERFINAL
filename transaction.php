  ...
  if (isset($_POST['pay'])){
    ...
    $id = $_SESSION['user_id'];
      if($balance > $bill){
        ...
        if($result){
            echo "<script>alert('Bought your tickets successfully, go check it out!');
                window.location.href='billinghistory.php'; </script>";
        }
      }
      else{
...
<body>
    ...
    <br><br><br>
    <form style="background:#A0E7E5; width:1000px; margin:auto; border: 2px solid black" action="transaction.php" method="POST" >
