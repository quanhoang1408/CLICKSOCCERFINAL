<?php
  ...
  $numseats = $_POST['numofseatsorder'];
    if($numseats < 0 || $numseats>getnumofseats($_SESSION['billid'])){
...
<html lang="en">
  ...
  <body>
      ...
      <br><br>
      <form style="background:#A0E7E5; width:1000px; margin:auto; border: 2px solid black" action="billing.php" method="POST" >
